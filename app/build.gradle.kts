...
dependencies {
    ...
    implementation("androidx.compose.material:material:1.3.1") // 用于Material图标
    implementation("androidx.navigation:navigation-compose:2.6.0") // 导航
    implementation("androidx.documentfile:documentfile:1.0.1") // 用于文件选择器
